...
import {clipSegment} from "leaflet/src/geometry/LineUtil.js";
...
function reducer(state, action){
    ...
    return {
        ...
        default:throw new Error('Unkn0own action type')
    }
...
function CitiesProvider({children}) {
    ...
    async function getCity(id) {
        ...
        try {
            ...
            dispatch({type: 'rejected', payload: 'There was error loading city data ... '})
        }
    }
    async function createCity(newCity) {
        ...
        try {
            ...
            dispatch({type: 'rejected', payload: 'There an error creating city... '})
        }
    }
    async function deleteCity(id) {
        ...
        try {
         await fetch(`${BASE_URL}/cities/${id}` , {
            ...
            dispatch({type: 'rejected', payload: 'There was a problem deleting city... '})
